													...
													wstring command)
{
	...
	{
		ScreenGUI* screen = game->getGUI()->getScreen(GS_MAIN_MENU);
		TextureManager* tMan = game->getGraphics()->getGUITextureManager();
		unsigned int imageID = tMan->loadTexture(W_CONTROLS_PATH);
