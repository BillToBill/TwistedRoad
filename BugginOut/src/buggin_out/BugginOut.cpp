                   ...
                   int nCmdShow)
{
	...
	bugginOutDataLoader->initAudio();
	bugginOutDataLoader->initGravSound(W_GRAV_SOUND);
	bugginOutDataLoader->initJumpSound(W_JUMP_SOUND);
	bugginOutDataLoader->initDieSound(W_DIE_SOUND);
	...
	BugginOutCollisionListener *bugginOutCollisionListener = new BugginOutCollisionListener(bugginOutGame);
